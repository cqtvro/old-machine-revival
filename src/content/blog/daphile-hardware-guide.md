...
> 很多烧友会问，为什么没有推荐闲鱼上 ¥40-¥60 元的经典神机 **惠普 T620**？
> T620 确实是无风扇（零噪音）的完美入场券，如果只做**双达菲模式下的“纯播放桥端（Bridge/Player）”**，它依然极其称职。但如果把它作为**单机系统**或者**核心端（Core）**跑大曲库扫描、甚至开启 **Brutefir/FIR 空间卷积滤波**，它搭载的旧款 AMD 双核/四核 APU 性能会瞬间满载吃紧，导致卡顿或切歌延迟。因此在新版 3.1.1 时代，我们更推荐升级为 Intel 平台（如 J4105、N5105 或 J1900）以获得更流畅的体验。
