...
> 很多初烧朋友会问，为什么没有推荐经典神机 **惠普 T620**？
> 实际上，虽然现在它的价格已经涨到了 **¥120 元左右**（以前 ¥40-¥60 的低价已成老黄历），但对于绝大多数**不折腾“空间卷积滤波（Brutefir）”或复杂“手动 EQ”等高阶玩法**的初学玩家来说，T620 依旧是**高性价比和静音的终极选择**！它最大的杀手锏是**完全无风扇被动散热（零噪音）**。只要你只是日常播放标准无损 CD 格式、常规 DSD 源码输出，T620 的性能完全能够轻松拿捏，是不折不扣的“入门良心券”。
> 
...
*   **价格区间**：¥150 - ¥250 元（准系统，不含内存与固态硬盘）。
*   **优点**：主板设计极为规范，底层 BIOS 兼容性极强。在达菲的实时内核（RT Kernel）下，驱动契合度接近 100%。
*   **缺点**：价格比同档次的瘦客户机略贵。需要注意的是，这个价格通常在闲鱼上只能买到**不带内存和硬盘的“准系统”**，玩家需要自己额外加装笔记本内存与固态硬盘（合计约 ¥50 - ¥100 元左右）。
