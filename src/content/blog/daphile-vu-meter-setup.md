...
> 达菲中文写盘工具 (v3.2.0 技术服务版)：该工具会在本地写盘时自动为您注入中文汉化集成、底层显示驱动调优以及组件配置。如果您在开启过程中找不到圆形双表头选项，或者遇到界面显示不全的问题，说明系统缺少对应的组件包。如需获取写盘工具、汉化包及技术指导服务，可联系我们获取支持。
...
快捷切换方法：
在播放音乐时，进入 「正在播放」 界面，直接点击屏幕左侧的图片区域（或者按下键盘上的 **`[`** 键，即字母 P 右侧的左中括号键），即可在各个显示模式之间依次循环切换。
...
💡 **温馨提示**：如需获取已完成全系统深度汉化集成、大屏显示调优的 **Daphile v3.2.0 中文写盘工具** 及专属技术支持，请访问我们的 [v3.2.0 正式版发布与下载专区](/blog/daphile-v320-release)，或直接添加站长微信 **`wxcq888`**（也可以点击这里 <a href="#contact" data-trigger-contact>👉【微信咨询/购买】</a> 快速唤起联系面板）直接沟通。
