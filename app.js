...
const BLOG_POSTS = [
    {
        ...
        title: "【折腾】闲置的惠威D1010MKII有源音箱，改成无源音箱，连上小胆机，味道不一样",
        summary: "今天我们来折腾一台旧音箱。这是一台闲置多年的惠威D1010MKII有源音箱。由于时间太久，功放部分电路老化，出现了一些杂音和电流声，丢了可惜，扔了心疼，于是我决定动手，将其改装成无源音箱。",
        category: "others",
        categoryName: "其他改造",
        date: "2026-05-18",
        readTime: "5 分钟阅读",
        ...
        content: `
            <p><strong>前言：今天我们来折腾一台旧音箱。</strong></p>
            <p>这是一台闲置多年的惠威D1010MKII有源音箱。由于时间太久，功放部分电路老化，出现了一些杂音和电流声，丢了可惜，扔了心疼，于是我决定动手，将其改装成无源音箱。</p>
            <p>改装的思路其实非常简单。</p>
            <p><strong>第一步：拆除内置的功放电路板，将它彻底掏空，只保留扬声器单元（高音和低音），然后重新布线接出。</strong></p>

            <img src="hivi_d1010_front.jpg" alt="惠威D1010MKII有源音箱">

            <p>拆开箱体后可以看到，主箱里面塞着功放板和变压器，而副箱里面则是空的。我们要把主箱里的变压器 and 功放板全部拆除，只保留箱体和喇叭，让它变成和副箱一样的无源结构。</p>
            ...
            <p>这里我使用了一个最简单实用的方案：高音喇叭正极串联了一个3.3uF的无极电容（作为一个一阶低通分频，过滤掉低频信号，防止烧毁高音单元），低音喇叭则直接直通。</p>
            <p>布线完毕后，把线头焊接到接线柱上，组装好箱体，大功告成。</p>

            <img src="potentiometer_mod.jpg" alt="布线与电容">

            <p><strong>第二步：为改装好的无源音箱选择合适的功放。</strong></p>
            <p>掏空功放电路后，音箱现在必须要依靠外置的功放来驱动了。我手头正好有一个闲置的数码小功放，使用的是TPA3116芯片，虽然体积小巧，但是驱动这台音箱绰绰有余。</p>

            <img src="tpa3116_amp_inside.jpg" alt="数码小功放">

            <p><strong>第三步：搭配老机器使用，让声音发挥出新的色彩。</strong></p>
            <p>为了测试实际效果，我找来了一台闲置的HP小主机作为播放源，通过USB接口连接解码器，再输出到功放，最后驱动音箱。</p>
            <p>整个系统在我的小电脑桌上安顿下来，接通电源，音乐响起的那一刻，我惊呆了。</p>
            <p>原本因为电路老化而存在的杂音、电流声彻底消失了。得益于TPA3116功放充足的功率，声音变得干净、扎实。</p>
            <p>低音部分有了一定的弹性，不像以前那种发闷、浑浊的感觉。</p>
            <p>高音部分经过电容分频，虽然不算特别细腻，但非常通透，非常适合听一些人声 and 轻音乐。</p>
            <p>这种折腾的乐趣，不仅仅是让一台旧设备重获新生，更是因为通过自己的双手，让废品变成了宝贝，让音乐再次流淌。</p>

            <img src="hp_mini_pc.jpg" alt="HP小主机">

            <p>为了进一步改善听感，我还计划给它搭配一个便宜的胆机前级。大家都说“胆机”声音暖，适合人声，这也为下一次折腾埋下了伏笔。</p>

            <img src="hivi_setup_final.jpg" alt="连接小胆机与功放">

            <hr>
            <p><strong>折腾清单：</strong></p>
            <ul>
                <li>1. 惠威D1010MKII有源音箱（闲置）</li>
                <li>2. 3.3uF无极分频电容 x2 （用于高音分频）</li>
                <li>3. 双孔音箱接线盒 x2</li>
                <li>4. TPA3116数码功放（闲置）</li>
                <li>5. HP小主机 + 简易解码器（播放源）</li>
            </ul>
            <p><strong>总花费：约15元</strong>（电容和接线盒费用，其余均为闲置设备）</p>

            <blockquote>
                <p><strong>结语：</strong></p>
                <p>“折腾”是一种生活态度。</p>
                <p>拯救旧设备，不一定需要高大上的技术，有时候一点点动手能力加一些奇思妙想，就能让那些积灰的“电子垃圾”重新焕发光彩。</p>
                <p>如果你手头也有闲置的旧音箱、旧功放、旧电脑，不妨也动手试试吧，让它们重新唱歌！</p>
                <p>欢迎在评论区留下你的折腾经历，一起交流心得！</p>
            </blockquote>
        `,
    },
    {
